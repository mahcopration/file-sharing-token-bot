...
DB_URI = "mongodb+srv://mhsm:mhsm@cluster0.j9figvh.mongodb.net/?retryWrites=true&w=majority"
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "0431193f060b4e4ae984ec82ea1ccdd87fdb3d61")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","howtodownloadfilesoffic/18")
